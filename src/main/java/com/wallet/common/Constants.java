...
public class Constants {
    ...
    public static final String CREATED_WALLET = "Wallet is created (wallet: {} --- name: {} --- balance: {})";
    public static final String CREATED_TRANSACTION = "Transaction is created (from: {} --- to: {} --- amount: {})";
    public static final String UPDATED_WALLET = "Wallet is updated (wallet: {} --- name: {} --- balance: {})";
    public static final String DELETED_WALLET = "Wallet is deleted (wallet: {} --- name: {} --- balance: {})";
